...
//var cntManager: CBCentralManager! // 주변 기기 검색 및 연결
//
...
//    override init() {
//        super.init()
//        cntManager = CBCentralManager(delegate: self, queue: nil)
//    }
//
//    
//    // MARK: 기기 검색을 위한 함수
...
//    
//    func startScan() {
//        guard cntManager.state == .poweredOn else {
//            print(cntManager.state.self)
//            return }
//        
//        print("스캔 시작스")
//        
...
//        cntManager.scanForPeripherals(withServices: [serviceUUID], options: nil)
//        
//        let peripherals = cntManager.retrieveConnectedPeripherals(withServices: [serviceUUID])
...
//        cntManager.connect(peripheral, options: nil)
//    }
//    
//    
